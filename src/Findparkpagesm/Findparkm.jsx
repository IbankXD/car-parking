        ...
        <div className="wallpaper3">
            ...
            <div className='gangjank'>
                ...
                <div className='land1'>
                    ...
                    <div><button className='land1btn' style={{ width: "70px", height: "30px", fontSize: "10px", }}>นำทาง</button></div>
            ...
            <button className="nav2-button" onClick={() => navigate('/dashboardv')}>
                <img className='icons' src="homes.png" alt="" />
                </button>
                <button className="nav2-button" onClick={() => navigate('/findparkm')}>
                <img className='icons' src="search.png" alt="" />
                </button>
                <button className="nav2-button active">
                <img className='scan' src="scan.png" alt="" />
                </button>
                <button className="nav2-button" onClick={() => navigate('/recentv')}>
                <img className='icons' src="recent.png" alt="" />
                </button>
                <button className="nav2-button" onClick={() => navigate('/visualv')}>
                <img className='icons' src="userpro.png" alt="" />
                </button>
            </div>
            <img className='userbanks1' src="Userbank.jpg" alt="" />
            <div className='userinfo1'> <p style={{ fontSize: "10px" }}>Siwats Kaewnongsung</p></div>
