        ...
        <div className='wallpaper2'>
            ...
            <div className='dashboard-content' >
                ...
                <div className='btn-container'>
                    ...
                    <button className='btnm' onClick={() => navigate('/recentv')}>
                ...
                <div className='info-dash'>
                    ...
                    <div className='info-dash1'>
                        <p style={{ fontSize: '10px' }}>USER : 095-XXX-XX32</p>
                        <p style={{ fontSize: '10px' }}>TYPE : VISITOR</p>
                    </div>
                </div>

                <div className='setnoti-dash'>
                    <div className='setting-dash'><button onClick={() => navigate('/usersettings')} style={{ backgroundColor: "transparent", border: "none", }} >
